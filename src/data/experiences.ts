...
export const EXPERIENCE_DATA: ExperienceData[] = [
  ...
  },
  {
    ...
    results: [
      {
        title: '20년 부산인디커넥트 페스티벌 GDWEB GRAND PRIZE 수상',
      },
      {
        title: '19년 공유마을 어플리케이션 부산국제디자인어워드(ibda) 수상',
      },
    ],
    projects: [
      {
        title: 'LH주거복지정보 홈페이지 리뉴얼 ',
        tags: ['UX/UI'],
      },
      {
        title: '오토닉스 회사소개 리뉴얼',
      ...
      {
        title: '아이오티플랙스 포가드 관제시스템',
        tags: ['UX/UI', 'Publishing', 'React'],
      },
      {
        title: '삼성바이오로직스 협력사 안전포탈 구축 ',
        tags: ['UX/UI', 'Publishing'],
      },
      {
        title: '보딩리스트 예약플랫폼 홈페이지 및 업무시스템, 키오스크 구축',
        tags: ['UX/UI', 'Publishing'],
      },
      {
        title: '20년~24년 부산인디커넥트 페스티벌 홈페이지 구축 및 운영',
        tags: ['UX/UI', 'Publishing'],
      },
      {
        title: '유디저브 플랫폼 구축',
      ...
      {
        title: '강원도/충북/제주 교육청 학교조직진단시스템 구축 ',
        tags: ['UX/UI', 'Publishing'],
      },
      {
        title: '20년~24년 부산경제진흥원 홈페이지 리뉴얼 및 웹접근성 인증 ',
        tags: ['UX/UI', 'Publishing', 'Web Accessbility'],
      },
      {
        title: '부산은행 태블릿 업무 시스템 구축',
        tags: ['UX/UI'],
      },
      {
        title: '신안산대학교 입학처 홈페이지 구축 및 웹접근성 인증',
        tags: ['UX/UI', 'Publishing', 'Web Accessbility'],
      },
      {
        title: '북방경제도시협의회 홈페이지 홈페이지 구축 ',
        tags: ['UX/UI', 'Publishing'],
      },
      {
        title: '울산공공보건의료지원단 설문조사 사이트 ‘울팸’ 구축',
        tags: ['UX/UI', 'Publishing'],
      },
      {
        title: '부산일보 지면보기 어플리케이션 디자인',
        tags: ['UX/UI'],
      },
      {
        title: '부산시설공단 홈페이지 리뉴얼 및 웹접근성 인증',
        tags: ['UX/UI', 'Publishing', 'Web Accessbility'],
      },
    ],
  },
